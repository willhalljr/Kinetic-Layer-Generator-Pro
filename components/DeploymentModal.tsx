      ...
      <div className="bg-zinc-900 border border-white/10 w-full max-w-2xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
        <div className="flex justify-between items-center p-6 border-b border-white/10 bg-black/40">
          <div>
            ...
            <p className="text-white/40 text-[10px] font-mono uppercase tracking-widest mt-1">Cloudflare Pages Dashboard</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8 text-white/80">
          <section className="bg-blue-500/10 border border-blue-500/20 p-6 rounded">
            <h3 className="text-blue-400 text-xs font-black uppercase tracking-widest font-mono mb-4">🔧 Fix Build Error</h3>
            <p className="text-sm mb-4">Your log showed "Permission denied" because the Build Command was wrong. Update your Cloudflare settings to exactly this:</p>
            <div className="bg-black border border-white/10 p-4 font-mono text-[11px] text-white/70 space-y-2">
               <div className="grid grid-cols-2 gap-y-1">
                  ...
                  <div className="text-white font-bold text-green-400">npm run build</div>
                  <div className="text-white/30">Build output directory:</div>
                  <div className="text-white font-bold text-green-400">dist</div>
               </div>
            </div>
            <p className="text-[10px] mt-4 text-white/40 italic">Note: Ensure "Root directory" is set to "/" (the default).</p>
          </section>

          <section>
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-white text-xs font-black uppercase tracking-widest font-mono">Shopify Liquid Code</h3>
              <button 
                onClick={handleCopy} 
